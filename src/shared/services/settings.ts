...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'siliconflow',
      title: 'Siliconflow',
      description: `Custom <a href="https://siliconflow.com" class="text-primary" target="_blank">Siliconflow</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
    ...
    },
    {
      ...
      description:
        'custom your <a href="https://affonso.io?atp=coloringpages" class="text-primary" target="_blank">Affonso</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'promotekit',
      ...
      description:
        'custom your <a href="https://www.promotekit.com?via=coloringpages" class="text-primary" target="_blank">PromoteKit</a> settings',
      tab: 'affiliate',
    },
    {
      name: 'crisp',
...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'ColoringPages is a platform for creating and coloring pages online. ',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'coloringpages.club',
      group: 'plausible',
      tab: 'analytics',
    },
    {
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'ColoringPages <no-reply@mail.coloringpages.club>',
      group: 'resend',
      tab: 'email',
    },
    {
    ...
    },
    {
      ...
      value: process.env.R2_DOMAIN || '',
      tip: 'Public domain for accessing R2 files (e.g., https://images.coloringpages.club)',
      group: 'r2',
      tab: 'storage',
    },
    {
